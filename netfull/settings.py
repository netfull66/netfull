"""
Django settings for netfull project.
...
SECRET_KEY = 'django-insecure-r)%z1y^=vb7xcvfcb+&*ogm5@#k1e-z9qpdzh9@0eg(iravw^p'
...
WSGI_APPLICATION = 'netfull.wsgi.application'
...
# Media files (optional, if you need to upload files)
MEDIA_URL = '/media/'
